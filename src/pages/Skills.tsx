...
function SkillPill({ skill }: Skill) {
    return (
        <div className={`skill-pill bg-transparent min-w-16 md:min-w-28 border text-center rounded-md md:rounded-xl p-1 cursor-default border-yellow-500`}>
            <span className={`text-[10px] md:text-base text-yellow-500`}>{skill}</span>
        </div>
    )
}
